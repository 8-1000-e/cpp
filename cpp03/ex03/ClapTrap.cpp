...
/*   Updated: 2025/04/24 14:02:23 by edubois-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::beRepaired(unsigned int amount)
{
    if (!isDead)
    {
        if (EnergyPoints)
            ...
            std::cout << this->Name << " tries to repair himself but he is out of energy" << std::endl;
    }
}
...
void ClapTrap::attack(const std::string &target)
{
    ...
    {
        std::cout << this->Name << " tries to attack " << target << " but is out of energy." << std::endl;
    }
    else if (this->isDead)
    {
        std::cout << this->Name << " tries to attack " << target << " but " << Name << " is dead." << std::endl;
    }
}
