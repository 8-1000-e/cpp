...
/*   Updated: 2025/04/24 10:49:53 by edubois-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::takeDamage(unsigned int amount)
{
    ...
    {
        HitPoints -= amount;
        std::cout << "ClapTrap " << Name << " takes " << amount << " amount of damage, new Hitpoints = " << HitPoints << std::endl;
        if (HitPoints <= 0)
        {
           isDead = 1; 
           std::cout << "ClapTrap " << Name << " took too much damage, " << Name << " is dead" << std::endl; 
        }
